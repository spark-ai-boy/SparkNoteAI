...
export const NotesConfigScreen: React.FC = () => {
  const colors = useTheme();
  const featureId = 'notes';
  const {
    schemasMap,
    settings,
    isLoadingSchemas,
  ...
  if (!schema) {
    return (
      <View style={[styles.center, { backgroundColor: colors.background }]}>
        <BookIcon size={48} color={colors.textTertiary} />
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.infoCard, { backgroundColor: colors.backgroundSecondary }]}>
        <BookIcon size={24} color={colors.blue} />
...
export default NotesConfigScreen;
